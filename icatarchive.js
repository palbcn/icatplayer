...
/* split icat.json in two given a date limit or a number of entries */
...
/* {"id":"AA-160791","artist":"Phoenix","title":"Lovelife","cover":"http://statics.ccma.cat/multimedia/jpg/3/8/1493374075183.jpg","timestamp":1522663450214,"like":false}*/


/******************************************************************************/
(function main(){ 
  if (process.argv.length<3) {
    return console.error('node icatarchive icat.json [archive.json]');
  }
  
  let infile = path.normalize(path.resolve(process.argv[2]))
